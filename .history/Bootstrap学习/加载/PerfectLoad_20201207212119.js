...
jQuery.bootstrapLoading = {
  start: function (options) {
    ...
    var _LoadingHtml =
      ...
      options.backgroundColor +
      // " url(/Content/bootstrap-loading/images/loading.gif) no-repeat 5px center; color:" +
      options.TipsColor +
      ';font-size:20px;">' +
      options.loadingTips +
      "</div></div>";
    ...
    var _LoadingTop =
        _PageHeight > _LoadingTipsH ? (_PageHeight - _LoadingTipsH) / 2 : 0,
      _LoadingLeft =
        _PageWidth > _LoadingTipsW ? (_PageWidth - _LoadingTipsW) / 2 : 0;
